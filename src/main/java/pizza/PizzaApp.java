...
public class PizzaApp {
    ...
    public static void main(String[] args) {
        ...
        try (var beanContainer = new AnnotationConfigApplicationContext(PizzaApp.class.getPackageName())) {
            ...
            System.out.println("\nProducts:");
            System.out.println(AsciiTable.getTable(products, List.of(
            ...
            System.out.println("\nCustomers:");
            System.out.println(AsciiTable.getTable(customers, List.of(
            ...
            if (!products.isEmpty() && !customers.isEmpty()) {
                ...
                System.out.println("\nOrder placed:");
                System.out.println(AsciiTable.getTable(List.of(order), List.of(
